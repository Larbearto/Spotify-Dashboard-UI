...
function Track({ track, chooseTrack }) {
  ...
  return (
    <div className='flex items-center justify-between space-x-30 cursor-default hover:bg-white/10 py-2 px-4 rounded-lg group transition ease-out'>
      <div className='flex items-center'>
        ...
        <div>
          ...
          <p className='text-[rgb(179,179,179)] text-[14px] font-semibold group-hover:text-white'>
            {track.artist}
          </p>
        </div>
      </div>
        ...
        <div className='flex items-center rounded-full border-2 border-[#262626] w-[85px] h-10 relative cursor-pointer group-hover:border-white/40'>
          ...
          {track.uri === playingTrack.uri && play ? (
            ...
            <div
              ...
              onClick={handlePlay}
            >
              <BsFillPlayFill className='text-white text-2xl ml-[1px]' />
            </div>
          )}
        </div>
      </div>
